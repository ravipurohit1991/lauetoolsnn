...
if __name__ == "__main__":    
    ...
    input_params = {
                    ...
                    # =============================================================================
                    "experimental_directory": r"C:\Users\purushot\Desktop\Cu_pads_Bassel\W02_SQ2E2\RT",
                    "experimental_prefix": "map_RT_",
                    "grid_size_x" : 17,           ## Grid X and Y limit to generate the simulated dataset (a rectangular scan region)
                    "grid_size_y" : 89,  
                    "UB_tolerance": [
                                     0.5,
                                     0.5
                    ...
                    "UB_matrix_detect": 3,
                    "material_phase_always_present": [2,1,1], ## in case if one phase is always 
    ...
    cap_matchrate = 0.50 * 100 ## any UB matrix providing MR less than this will be ignored
    ...
    model_annote = input_params["NN_model"]
