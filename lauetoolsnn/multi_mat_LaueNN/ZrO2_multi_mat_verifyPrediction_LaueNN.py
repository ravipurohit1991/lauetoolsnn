...
if __name__ == "__main__":    
    ...
    input_params = {
                    ...
                    "pixelsize" : 0.03670000,          ## Detector pixel size
                    "dim1":4036,                   ## Dimensions of detector in pixels
                    "dim2":4032,
                    ...
                    # =============================================================================
                    "experimental_directory": r"F:\MA4959_Laue_HT_2022Jan\bm32",
    ...
    model_annote = input_params["model"]
    ...
    use_om_user = "true"
    path_user_OM = r"F:\MA4959_Laue_HT_2022Jan\bm32\user_mat_UB.txt"
    ...
    config_setting.set('CALLER', 'path_user_OM',path_user_OM)
    ...
    directory_all = [
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220128\1250Cfriday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220128\1200Cfriday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220128\1150Cfriday",
                    # r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\1100Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\1050Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\1025Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\1000Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\990Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\980Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\970Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\960Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\950Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\940Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\930Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\920Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\910Csaturday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220129\900Csaturday",                    
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220130\880Csunday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220130\860Csunday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220130\840Csunday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220130\820Csunday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220130\800Csunday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220130\750Csunday",
                    r"F:\MA4959_Laue_HT_2022Jan\bm32\20220130\600Csunday",
                    ]
    
    
    filenm1 = np.chararray((41,41), itemsize=1000)
    filenm1 = filenm1.ravel()
    digits = len(str(41*41))
    digits = max(digits,4)
    # Temp fix
    for ii in range(41*41):
        text = str(ii)
        if ii < 10000:
            string = text.zfill(4)
        else:
        ...
        filenm1[ii] = file_name_temp
    filenm1 = filenm1.reshape((41,41))
    indid = np.diag_indices_from(filenm1)
    temp_obj = filenm1[indid]
    
    indexes = [ temp_obj[ii].decode().split("//")[-1].split(".")[0][-4:] for ii in range(len(temp_obj))]

    for index_search in indexes:
        print(index_search)
        try:
            list_of_files = []
            for filenameDirecg in directory_all:
                filee = glob.glob(filenameDirecg+'//'+'*.'+format_file)
                for ijk in filee:
                    if ijk.split(".")[0].split("\\")[-1][0] =="Z" and \
                        ijk.split(".")[0].split("\\")[-1][-4:] == index_search and \
                            "pfoc" not in ijk.split(".")[0].split("\\")[-1]:
                        list_of_files.append(ijk)
                
            topop = None
            for indi, iji in enumerate(list_of_files):
                if "Zr900" in iji and "HRLaue" not in iji:
                    topop = indi
            if topop is not None:
                list_of_files.pop(topop) ## for 900C a duplicate
            ...
            if 1:
                ...
                #% Save results
                save_directory_ = filenameDirec+"//results_"+prefix_mat+"_"+index_search
            ...
            print("Error in fileno " + index_search)
