...
if __name__ == "__main__":    
    ...
    input_params = {
                    ...
                    "prefix" : "_CNN_DNN",                 ## prefix for the folder to be created for training dataset
                    "symmetry": ["cubic",
                                 "cubic",
                    ...
                    "grid_size_x" : 89,            ## Grid X and Y limit to generate the simulated dataset (a rectangular scan region)
                    "grid_size_y" : 17,  
                    "UB_tolerance": [0.6,
                                     0.6,
                                     ],
                    ...
                    "UB_matrix_detect": 5,
                    "material_phase_always_present": [2,1,1,1,1],
