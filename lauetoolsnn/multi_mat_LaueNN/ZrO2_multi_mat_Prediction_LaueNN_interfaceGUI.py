...
if __name__ == "__main__":    
    ...
    input_params = {
                    ...
                    # =============================================================================
                    "experimental_directory": r"C:\Users\purushot\Desktop\Laue_Zr_HT\1250Cfriday\cor_files\LT_ROIs",
    ...
    cap_matchrate = 0.40 * 100 ## any UB matrix providing MR less than this will be ignored
    coeff = 0.10            ## coefficient to calculate the overlap of two solutions
    coeff_overlap = 0.20   ##10% spots overlap is allowed with already indexed orientation

    ## Additional parameters to refine the orientation matrix construction process
    use_om_user = "true"
    path_user_OM = r"C:\Users\purushot\Desktop\Laue_Zr_HT\model_crg4\user_mat_UB.txt"
